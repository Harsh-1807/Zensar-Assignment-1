...
setInterval(playMemeVideo, 100000);
...
function playMemeVideo() {
    ...
    if (!memeVideo) {
        console.error('Meme video element not found.');
        return;
    }

    
    memeVideo.style.display = 'block';
    memeVideo.src = 'Just do it!.mp4'; // Ensure the correct path to the video
    ...
    memeVideo.onended = () => {
        ...
        }, 50000); // Wait for 10 seconds before replaying the video
    };
